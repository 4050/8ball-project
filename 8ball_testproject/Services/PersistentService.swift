...
// Добрый день, Юрий! Я понял все, что вы мне написали, но не успел закончить. Отправляю как есть. Готов переделать в ближайшие сроки, но это уже вторая проверка, и я все понимаю. Спасибо за знания! Это был лучший опыт!
